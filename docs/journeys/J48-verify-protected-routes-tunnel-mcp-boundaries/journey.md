...
Evidence: `AGENTS.md:27-36`, `README.md:77-99`, `config/codex-automations.json`, `.mcp.json`/tool configuration where present, Beads `orc-n2q.379.49`, and review `orc-n2q.379.101`. Acceptance requires current read-only route, origin, ownership, and MCP-boundary receipts.
