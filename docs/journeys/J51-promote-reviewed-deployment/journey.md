...
Evidence: `AGENTS.md:29-39,61-67`; `README.md:88-100`; `.github/`; `deploy/`; Beads `orc-n2q.379.52`, review `orc-n2q.379.104`. Acceptance requires exact reviewed-head parity, independent approval, protected pre/post/rollback receipts, and current runtime readback.
