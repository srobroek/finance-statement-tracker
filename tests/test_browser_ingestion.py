...
class BrowserIngestionTests(TestCase):
    ...
    def test_inactive_n8n_handoff_validates_browser_capture_before_writes(self):
        ...
        self.assertIn("Generated by generate_browser_capture_validator.mjs", code)
        self.assertIn("const validateBrowserCapture =", code)
        self.assertIn("validateBrowserCapture.errors", code)
        self.assertNotIn("require(", code)
        self.assertNotIn("BROWSER_CAPTURE_SCHEMA_VALIDATOR_UNAVAILABLE", code)
