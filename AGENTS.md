...
- Codex schedule, model, status, notification policy, and prompt contracts: `config/codex-automations.json`; reusable execution logic lives under `agents/automations/`.
