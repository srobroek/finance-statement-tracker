...
| Browser acquisition | Ready; real export staged, commit awaiting review | The original ADCB portal CSV at legacy `_source/adcb_may_jun.csv` produced the same SHA-256 (`32444d7848209c69842e83caeb89fbb273fa46b3064625444576517786a310dc`) locally and in release `dfa697d` on the production container. Both parsed 303/303 rows with zero import blockers. Static rules cleared 11 deterministic cashback/payment credit flags, leaving one genuinely ambiguous credit for review. Production job `c278b3e939d3d1be6aa17eaa` proves upload, content-addressing, parsing, account mapping, scoped AI-request generation, rule staging, and durable job persistence without writing Actual. |
