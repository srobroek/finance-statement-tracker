...
| 52 | `AGENT-002` | `agent_runtime` | P1 | `PARTIAL` | Prove server-owned normal and exception model routing, including the gated high-reasoning path, in disposable n8n. |
...
| `ACTUAL-016` | `actual_finance` | `ACTUAL-002`, `ACTUAL-009`, `ACTUAL-012`, `ACTUAL-013` | `PARTIAL` | PARTIAL / CONFIG_SCAFFOLD_ONLY; 4 files, 1 tests; live readback: recorded; 4 acceptance checks; validator: full Python suite plus disposable Actual and authenticated UI/API readback | Comprehensive filterable dashboards and saved reports |
