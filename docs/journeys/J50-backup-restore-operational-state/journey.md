...
Evidence: `docs/backup-and-restore.md`, `AGENTS.md:9-13,29-36`, `deploy/`, `tests/test_backup_verifier.py`, Beads `orc-n2q.379.51`, and review `orc-n2q.379.103`. Acceptance requires protected backup/restore/replay/rollback receipts and exact no-mutation boundaries.
