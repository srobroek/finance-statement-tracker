...
Evidence: `AGENTS.md:29-36`, `README.md:88-99`, `integrations/n8n/`, `config/codex-automations.json`, Beads `orc-n2q.379.48`, and review `orc-n2q.379.100`. Acceptance is exact digest/topology parity, inactive/write-disabled state, and protected rollback proof.
