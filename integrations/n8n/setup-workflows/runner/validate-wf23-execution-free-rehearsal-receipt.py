#!/usr/bin/env python3
"""Validate one recent, redacted execution-free WF23 PostgreSQL rollback-rehearsal receipt."""
...
def validate_receipt(
    ...
    *,
    ...
    if value["status"] != "VERIFIED" or value["scope"] != "WF23_EXECUTION_FREE_POSTGRESQL_ROLLBACK_REHEARSAL":
...
def main() -> int:
    if len(sys.argv) != 9:
        print("WF23_EXECUTION_FREE_REHEARSAL_RECEIPT_REJECTED", file=sys.stderr)
        return 2
    try:
        ...
        print("WF23_EXECUTION_FREE_REHEARSAL_RECEIPT_REJECTED", file=sys.stderr)
        return 1
    print("WF23_EXECUTION_FREE_REHEARSAL_RECEIPT_VERIFIED")
    return 0
