...
CORPUS_SNAPSHOT = {
    ...
    "03-shared-statement-pipeline.json": {
        ...
        "connections_sha256": "8899015352c0d876409cd3a17a7f89222965f691c457a842be96cb4be251f475",
        "parameters_sha256": "c38894b7b1a068f9667d4dd3b24555dc1f60be24d9a7e0c7380ced7b8109aa69",
    ...
    "10-finance-operations-status.json": {
        ...
        "connections_sha256": "5dc831003a27552281822880529d6683c82c175e78d62198d083c34f826a061b",
        "parameters_sha256": "9367ebd6dd88684cbeb5d7ced3e17bc1f397eacc4e299606bbed8d7fa3deafbb",
        "groups_sha256": "5a39b4b25dda39f54f67c5e381af45580c26ccfc82226b6cb71694cd1076fadb",
    },
    ...
    "12-outlook-message-sweep.json": {
        ...
        "parameters_sha256": "6fc11b721dc020d9cbb503feef489a1bdb74d80946480d81f9f54853d6f89e01",
    ...
    "14-local-pdf-extraction.json": {
        ...
        "connections_sha256": "ef8146ce3ee13dcdd3a0bd3bd26486ff63aee69da535b16bc50f0ad58563e5f1",
        "parameters_sha256": "694448c6f9bc0a0b2ca689ce11d2dcfccfd1569d2af627b1325f6f2d913629b3",
        "groups_sha256": "a5948aa6a926cc968e40a5029a570829da9cd58c865494ccbb68e85d7af2a2a6",
    },
    ...
    "16-operations-error-handler.json": {
        ...
        "parameters_sha256": "125427e29862d13dba4a9567c1f5fb95195a7a16a8d0020f360999cc0c4a8620",
    ...
    "17-actual-outbox-recovery.json": {
        ...
        "connections_sha256": "71d8b24803954acdc935171043d45e089213dba7da5845ffe00c1a090714c829",
        "parameters_sha256": "5a54e27c72f882cfce8ca806e5a61ce5a119ff4a6ffe79f0f1e9c9c6c8070987",
        "groups_sha256": "5072c97ee4ac468e8968823f444ba888e6375880e2cc91d78b907aa9713f9eee",
    },
    ...
    "20-actual-outbox-apply.json": {
        ...
        "connections_sha256": "d73d5b4e2a2a4b476fdd207b29377a717ad0859d03b7eb79b58030481a7f8e72",
        "parameters_sha256": "b82bcd95ceaabfa3c5edec5938076fcdcfd2b2e993f80aabcdb6e37c01ff0794",
        "groups_sha256": "efdc4ca2ed837f5f2784de2b5320b2f6c345d4b16c0a4c0e83a264346dabf44a",
    },
...
VISUAL_CLEANUP_SNAPSHOT = {
    "01-outlook-finance-acquisition.json": {
        ...
        "parameters_sha256": "92fb1d6d62e49809a1d4c27d6c079fc847c93e5ad59692f97a7636c70674e4c5",
    },
    "02-rakbank-live-cashback.json": {
        "nodes": 12,
        "sticky": 0,
        "node_ids_sha256": "2e195a65a480836bc390a0af0932abd2f34b77c2aa0b7dc2f3a6891130138fa6",
        "parameters_sha256": "877b8acdf24ff09004a9116363536f7f121e728d0c14d038df99d2c507fcb90d",
    },
    "03-shared-statement-pipeline.json": {
        "nodes": 50,
        "sticky": 0,
        "node_ids_sha256": "8d9d934d5f8ca8bd9da08ce9231c9e40cd2415cee55719b622533c7d78a533df",
        "parameters_sha256": "e4150aa679fa7cae08dc7d8a282387ad85657c332444fd9fff7b7c0ccf94ef00",
    },
    "04-ei-monthly-statement.json": {
        "nodes": 3,
        "sticky": 0,
    ...
    "09-ai-proposal.json": {
        ...
        "sticky": 0,
        "node_ids_sha256": "8400f4d566da50dc7f4ee9a7fb78004b777e8be1269217b893a52dfce610584e",
        "parameters_sha256": "6db2337f12524e03be4d62ee1b9d7abbfcbfafae935d58246b833384a515b556",
    },
    "10-finance-operations-status.json": {
        "nodes": 25,
        "sticky": 0,
        "node_ids_sha256": "f6b59ff200bd0e0bbeb8d61e39d4cd2f91ba9dbe690825077043816386fc0330",
        "parameters_sha256": "3e46b03a197555cb08fc5e268d241b26a36687f1cdbd26ef2f1a9fad46edd359",
    },
    "11-interactive-artifact-handoff.json": {
        "nodes": 22,
        "sticky": 0,
        "node_ids_sha256": "d1fadaeaf61dd29d98518ad6aaf6756a800b5279556cee09a8b7f2cf4735cc37",
        "parameters_sha256": "4839d9888cfe794287c827c76aee3112683026d94433d3017d7da8bd1da26fe4",
    },
    "12-outlook-message-sweep.json": {
        "nodes": 94,
        "edges": 99,
        "sticky": 0,
        "groups": 16,
        "node_ids_sha256": "fda055a1109aad7121f97f012e5e5775e4a5b17f78235f26734f53a358c63148",
        "connections_sha256": "19200ee05b58c1284d672320e9fe45edab31146b1746358f255182861f144564",
        "parameters_sha256": "715612f0449a64f42c5be105240902c207771d8b0dcb2a24b9f46b8a45af9c8c",
        "groups_sha256": "9f350a35f8080dd157c6b991fe7a2b8eba0ff870566b53ad7a1a3b5baba836a0",
    },
    "13-document-extraction-request.json": {
        "nodes": 8,
        "sticky": 0,
        "node_ids_sha256": "a414f6411a3b668c9b234320bc32481b19bd90297421dd8da00dc075a86746df",
        "parameters_sha256": "d9399486f228a02a337f8a914ce5a50fe6954f1c9131f3a0599b758e1312f2b5",
    },
    "14-local-pdf-extraction.json": {
        "nodes": 12,
        "sticky": 0,
        "node_ids_sha256": "30b6c2a93fbb9622727bb2c23b8eafdededa10997bd78ae8ba16c28632fc5eef",
        "parameters_sha256": "70ff80090f68662b970908dd5af0eae3e987ac6e604f18094a2cb2c0570ddc2b",
    },
    "16-operations-error-handler.json": {
        "nodes": 13,
        "sticky": 0,
        "node_ids_sha256": "6d4bb1d21f537808601ee5ba2e7d266d1f2d940712b21bfbc92bd796175f1738",
        "parameters_sha256": "e5da1cabbca70c3a920ea92f569cb3156d7bc5dacabc2dab41309adc9771dcd9",
    },
    "17-actual-outbox-recovery.json": {
        "nodes": 5,
        "sticky": 0,
        "node_ids_sha256": "bff70dbba6a16eaa6098b1e41238572d621173c8dad043334c08c1662a587f89",
        "parameters_sha256": "f7f1452b6cc319c95382aa5ed29df1cc95d399820b14009d4264d2f5ce0714f1",
    },
    "18-finance-writer-lease.json": {
        "nodes": 7,
        "sticky": 0,
        "node_ids_sha256": "540ec1502e83accc5d6e45648b638799e80cc02cbede1f547087967ea9d158ab",
        "parameters_sha256": "f618fef6e867b529dfe80cfe1ac1cda38d7dbe059c718fe1cb1acb42ff876de3",
    },
    "19-platform-data-table-bootstrap.json": {
        "nodes": 12,
        "sticky": 0,
        "node_ids_sha256": "5be5f493de12fe7d6ad7f44f7bc7c3d13cdc653cabf149df14c128b0b0038a38",
        "parameters_sha256": "5e55338fdda4bb878b4d54644961087a362d55810a5ebc29c11f12e771805fae",
    },
    "20-actual-outbox-apply.json": {
        "nodes": 39,
        "sticky": 0,
        "node_ids_sha256": "1ae4aea6637813436034ac369cd83f9d573ad56d9f2fe0a6cec271ae958ded9c",
        "parameters_sha256": "248bbb4ab30faf8353a50c27d320c6e6c80f8f4c48aaed169c311f50fe055d72",
    },
    "21-subscription-agent-adapter.json": {
        "nodes": 5,
        "edges": 4,
    ...
    "22-shared-monthly-statement-cycle.json": {
        ...
        "parameters_sha256": "d1e25a14e94acebd3a72b82afc4963378ecab3b710376bbd284f870bcb83c358",
    },
}
...
def registry_export_code_mismatches(
    ...
    for row in rows:
        ...
        workflow = workflows.get(filename) if isinstance(filename, str) else None
        export_code = (
            workflow.get("meta", {}).get("financeWorkflowCode") if workflow else None
        )
...
class N8nWorkflowCorpusIntegrityTests(unittest.TestCase):
    ...
    def assert_metric(
        self, filename: str, metric: str, expected: object, actual: object
    ) -> None:
        self.assertEqual(
            actual,
            expected,
    ...
    def test_registry_and_folder_manifest_are_bijective(self) -> None:
        ...
        self.assertEqual(
            len(registry_files), len(set(registry_files)), "duplicate registry files"
        )
        self.assertEqual(
            len(registry_codes), len(set(registry_codes)), "duplicate registry codes"
        )
        self.assertEqual(
            set(registry_files),
            set(self.workflows),
            "registry/export file bijection drift",
        )
        self.assertEqual(
            {
        ...
        folders_by_id = {
            folder["id"]: folder for folder in self.folder_manifest["folders"]
        }
        folder_by_code = {
        ...
        self.assertEqual(
            len(folder_keys),
            len(set(folder_keys)),
            "duplicate folder names within a parent",
        )
        ...
        self.assertEqual(
            set(codes),
            set(registry_codes),
            "folder/registry workflow-code bijection drift",
        )
        self.assertEqual(
    ...
    def test_node_ids_are_unique_and_connections_have_no_dangling_endpoints(
        self,
    ) -> None:
        ...
        for filename, workflow in self.workflows.items():
            ...
            with self.subTest(workflow=filename):
                self.assertEqual(
                    duplicate_names,
                    [],
                    f"{filename}: duplicate node names: {duplicate_names}",
                )
                self.assertEqual(
                    duplicate_ids,
                    [],
                    f"{filename}: duplicate node IDs: {duplicate_ids}",
                )
                ...
                for output_type, branches in outputs.items():
                    if not isinstance(branches, list):
                        malformed_edges.append(
                            f"{source}/{output_type}: branches is not a list"
                        )
                        continue
                    for branch_index, branch in enumerate(branches):
                        if not isinstance(branch, list):
                            malformed_edges.append(
                                f"{source}/{output_type}[{branch_index}]: branch is not a list"
                            )
                            continue
            ...
            with self.subTest(workflow=filename):
                self.assertEqual(
                    unknown_sources,
                    [],
                    f"{filename}: dangling source nodes: {unknown_sources}",
                )
                self.assertEqual(
                    unknown_targets,
                    [],
                    f"{filename}: dangling target nodes: {unknown_targets}",
                )
                self.assertEqual(
                    malformed_edges,
                    [],
                    f"{filename}: malformed connections: {malformed_edges}",
                )

        duplicate_global_ids = sorted(
            node_id
            for node_id, count in Counter(
                node_id for _, node_id in all_node_ids
            ).items()
            if count > 1
        )
        self.assertEqual(
    ...
    def test_generated_stage_labels_are_removed_and_blocker_warnings_remain(
        self,
    ) -> None:
        sticky_ids = {
            node["id"]
    ...
    def test_workflow_counts_and_fingerprints_are_deterministic(self) -> None:
        for filename, workflow in self.workflows.items():
            ...
            group_node_ids = [
                node_id for group in groups for node_id in group["nodeIds"]
            ]
