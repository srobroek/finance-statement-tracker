...
| [`@openai/codex@0.148.0`](https://www.npmjs.com/package/@openai/codex) | Official OpenAI CLI; modified 2026-08-19; Apache-2.0; [source](https://github.com/openai/codex) | Historical private-runner option; retained here as superseded audit evidence. | Workflow 21 direct pinned subscription nodes are the intended boundary; no private runner is part of the active design. | Superseded; do not deploy. |
