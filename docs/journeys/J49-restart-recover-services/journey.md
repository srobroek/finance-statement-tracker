...
Evidence: `AGENTS.md:29-39`; `README.md:97-100`; `deploy/`; `scripts/`; Beads `orc-n2q.379.50`, review `orc-n2q.379.102`. Acceptance requires exact identity, protected pre/post receipts, and restart/recovery parity.
